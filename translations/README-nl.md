...
> Oorspronkelijk heb ik dit gemaakt als een kleine to-do lijst van studieonderwerpen om een software engineer te worden,
> maar het groeide uit tot de lange lijst die je nu kunt zien. Nadat ik dit studie plan ben doorgaan, [ben ik aangenomen als een Software Development Engineer bij Amazon](https://startupnextdoor.com/ive-been-acquired-by-amazon/?src=ciu)!
> Je hoeft waarschijnlijk niet zoveel te studeren als ik heb gedaan. Hoe dank ook, hier is alles wat je nodig hebt.
> 
> Ik studeerde voor ongeveer 8-12 uur per dag, voor meerdere maanden. Hier is mijn verhaal: [Waarom ik 8 maanden full-time gestudeerd heb voor een Google Interview](https://medium.freecodecamp.org/why-i-studied-full-time-for-8-months-for-a-google-interview-cc662ce9bb13)
> 
> **Houd er rekening mee dat:** Je hoeft niet zoveel te studeren als ik heb gedaan. Ik heb een heleboel tijd verspild aan dingen die ik niet hoefte te weten. Meer info daarover hieronder. Ik zal je helpen om daar te komen zonder je kostbare tijd te verspillen.
> 
> De artikelen die hier worden vermeld zullen je goed voorbereiden voor technische interviews bij zo ongeveer elk software bedrijf,
> inclusief de reuzen: Amazon, Facebook, Google en Microsoft.
> 
> *Veel geluk!*

<details>
<summary>Vertalingen:</summary>
...
<details>
<summary>Vertalingen in uitvoering:</summary>
...
![Coderen op het whiteboard - van HBO's Sillicon Valley](https://d3j2pkmjtin6ou.cloudfront.net/coding-at-the-whiteboard-silicon-valley.png)

Dit is mijn meerdere maanden studie plan voor het worden van een software engineer voor een groot bedrijf.

**Vereist:**
* Een beetje ervaring met programmeren (variabelen, loops, methodes en functies, etc)
* Geduld
* Tijd

Let op dit is een studie plan voor **software engineering**, niet web development. Grote software bedrijven als Google, Amazon,
Facebook en Microsoft zien software engineering als verschillend van web development. ALs voorbeeld, Amazon heeft
Frontend Engineers (FFE) en Software Development Engineers (SDE). Dit zijn twee verschillende rollen en de interviews voor
ze zullen niet hetzelfde zijn, aangezien elke zijn eigen competenties heeft. Deze bedrijven vereisen computer science kennis voor
software development/engineering posities.
...
- [Waarom zou je het gebruiken?](#waarom-zou-je-het-gebruiken)
- [Hoe het te gebruiken](#hoe-het-te-gebruiken)
- [Heb niet het gevoel dat je niet slim genoeg bent](#heb-niet-het-gevoel-dat-je-niet-slim-genoeg-bent)
- [Een opmerking over videobronnen](#een-opmerking-over-videobronnen)
- [Kies een programmeertaal](#kies-een-programmeertaal)
- [Boeken voor Data Structuren en Algoritmen](#boeken-voor-data-structuren-en-algoritmen)
- [Interview Voorbereidingsboeken](#interview-voorbereidingsboeken)
- [Maak Niet Mijn Fouten](#maak-niet-mijn-fouten)
- [Wat je niet behandeld zult zien worden](#wat-je-niet-behandeld-zult-zien-worden)
- [Het Dagelijkse Plan](#het-dagelijkse-plan)
- [Oefenen voor codeervragen](#oefenen-voor-codeervragen)
- [Coderingproblemen](#coderingsproblemen)

### Onderwerpen van de Studie

- [Algoritmische complexiteit / Big-O / Asymptotische analyse](#algotitmische-complexiteit--big-o--asymptotische-analyse)
- [Data Structuren](#data-structuren)
    - [Arrays (Reeks)](#arrays)
    - [Linked Lists (Gekoppelde Lijst)](#linked-lists)
    - [Stack (Stapel)](#stack)
    - [Queue (Wachtrij)](#queue)
    - [Hash table (Hash Tafel)](#hash-table)
- [Meer Kennis](#meer-kennis)
    - [Binair Zoeken](#binair-zoeken)
    - [Bitsgewijze Bewerkingen](#bitsgewijze-bewerkingen)
- [Trees (bomen)](#trees)
    - [Trees - Opmerkingen & Achtergrond](#trees---opmerkingen--achtergrond)
    - [Binaire zoekbomen: BSTs](#binaire-zoekbomen-bsts)
    - [Heap / Prioriteits-rij / Binaire Heap](#heap--prioriteits-rij--binaire-heap)
    - Gebalanceerde zoekbomen (algemeen concept, geen details)
    - traversalen: preorder, inorder, postorder, BFS, DFS
- [Sorteren](#sorteren)
    - selectie
    - invoeging
    - heapsort (heap sorteren)
    - quicksort (snel sorteren)
    - merge sort (samenvoeging sorteren)
- [Grafieken](#grafieken)
    - directed (verwezen)
    - undirected (niet verwezen)
    - adjacency matrix (aangrenzende matrix)
    - adjacency list (aangrenzende lijst)
    - traversals: BFS, DFS (traversalen, Breedte Eerst Zoekopdracht, Diepte Eerst Zoekopdracht)
- [Nog Meer Kennis](#nog-meer-kennis)
    - [Herhaling](#herhaling)
    - [Dynamisch Programmeren](#dynamisch-programmeren)
    - [Ontwerp Patronen](#ontwerp-patronen)
    - [Combinatoriek (n kiest k) & Waarschijnlijkheid](#combinatoriek-n-kiest-k--waarschijnlijkheid)
    - [NP, NP-Compleet en Benaderingsalgoritmen](#np-np-compleet-en-benaderingsalgoritmen)
    - [Hoe computers een programma verwerken](#hoe-computers-een-programma-verwerken)
    - [Caches (Noodvoorraad)](#caches)
    - [Processen and Threads](#processen-and-threads)
    - [Testen](#testen)
    - [String zoeken & manipulaties](#string-zoeken--manipulaties)
    - [Tries (prefix boom)](#tries)
    - [Floating Point Numbers (Zwevendekommagetal)](#floating-point-numbers)
    - [Unicode](#unicode)
...
- [Update Je CV](#update-je-cv)
- [Zoek een baan](#zoek-een-baan)
- [Sollicitatieproces & Algemene Sollicitatievoorbereiding](#sollicitatieproces--algemene-sollicitatievoorbereiding)
- [Denk aan voor als het interview komt](#denk-aan-voor-als-het-interview-komt)
- [Heb vragen voor de interviewer](#heb-vragen-voor-de-interviewer)
- [Zodra je de baan hebt](#zodra-je-de-baan-hebt)

**---------------- Alles onder dit punt is optioneel ----------------**

### Optionele Extra Onderwerpen & Bronnen

- [Extra Boeken](#extra-boeken)
- [Systeem Design, Schaalbaarheid, Gegevensverwerking](#systeem-design-schaalbaarheid-gegevensverwerking) (if you have 4+ years experience)
- [Aanvullend Leren](#aanvullend-leren)
    - [Compilers (samemnsteller/opbouwer)](#compilers)
    - [Emacs en vi(m)](#emacs-en-vim)
    - [Unix command line tools (opdrachtregelprorammas)](#unix-command-line-tools)
    - [Informatie theorie](#informatie-theorie-videos)
    - [Pariteit & Hamming Code](#pariteit--hamming-code-videos)
    - [Entropie](#entropie)
    - [Cryptografie](#cryptografie)
    - [Compressie](#compressie)
    - [Computer Beveiliging](#computer-beveiliging)
    - [Garbage Collection (Vuilnisophaling)](#vuilnisophaling)
